      ...
      <div className="container mx-auto px-4 py-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600 mb-8">
            A production-ready showcase of all <strong>React 19 features</strong> with 
            Next.js 15, featuring drag-and-drop, real-time updates, and AI-powered forms.
          </p>
        ...
        <Card className="bg-gradient-to-r from-blue-500 to-purple-600 text-white border-0">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-white/90 text-lg">
              See all React 19 features in action with interactive demos
            </CardDescription>
          </CardHeader>
